...
exports.encontrarNumeroFaltante = encontrarNumeroFaltante;
exports.encontrarNumeroFaltanteXOR = encontrarNumeroFaltanteXOR;
/* ============================================================
...
function encontrarNumeroFaltante(nums) {
    ...
    const sumaReal = nums.reduce((acum, valor) => acum + valor, 0);
    // La diferencia es el número faltante
    const faltante = sumaEsperada - sumaReal;
    return faltante;
}
/* ============================================================
   ...
   ============================================================ */
function encontrarNumeroFaltanteXOR(nums) {
    const n = nums.length + 1;
...
(function probar() {
    ...
    const nums1 = [3, 7, 1, 2, 8, 4, 5];
    console.log("Ejemplo (Gauss):", encontrarNumeroFaltante(nums1)); // 6
    console.log("Ejemplo (XOR):  ", encontrarNumeroFaltanteXOR(nums1)); // 6
    // Casos extra
    const nums2 = [1, 2, 3, 5]; // Falta 4 (N=5)
    const nums3 = [2, 3, 4, 5]; // Falta 1 (N=5)
    const nums4 = [1, 3, 4, 5]; // Falta 2 (N=5)
    const nums5 = [1, 2, 4, 5, 6, 7]; // Falta 3 (N=7)
